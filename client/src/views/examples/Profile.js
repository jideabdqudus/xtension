                ...
                <div className="mt-5 py-5 border-top text-center">
                  ...
                  <Row>
                    <Col lg="6">
                      ...
                      <Card>
                        {user.experience.map((expert) => (
                          <CardBody key={expert.company}>
                            <TabContent>
                              <TabPane>
                                <h5>{expert.company}</h5>
                                <h6>
                                  {expert.start} till {expert.end}
                                </h6>
                                <p className="description">
                                  <b>Position:</b> {expert.position}
                                </p>
                                <p className="description">
                                  <b>Location:</b> {expert.location}
                                </p>
                                <p className="description">
                                  <b>Description:</b> {expert.description}
                                </p>
                              </TabPane>
                            </TabContent>
                          </CardBody>
                    ...
                    <Col lg="6">
                      ...
                      <Card>
                        {user.education.map((student) => (
                          <CardBody>
                            <TabContent>
                              <TabPane>
                                <h5>{student.school}</h5>
                                <h6>
                                  {student.start} till {student.end}
                                </h6>
                                <p className="description">
                                  <b>Degree:</b> {student.degree}
                                </p>
                                <p className="description">
                                  <b>Field of Study:</b> {student.field}
                                </p>
                              </TabPane>
                            </TabContent>
                          </CardBody>
